  ...
  static async get(params: any) {
    ...
    try {
      ...
      if (!cookies.get("token.auth")) {
        ...
        window.location.href = import.meta.env.VITE_ROUTER_SIGNIN;
      }
          ...
          emitNotification({
            logout: {
              ...
              notify: {
                ...
                message:
                  "you do not have a valid authorization token. probably because it is already expired.",
              },
            },
          });
