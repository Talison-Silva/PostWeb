  ...
  <FooterInfors>
    <FooterInforsPostweb>
      ...
      <p className="text-[18px]">
        PostWeb is an old project written in ReactJS, which was originally just
        ...
        functionalities. In addition, I improved the code, which was previously
        susceptible to failures, bugs and improper access. Thanks to various
        concepts learned over the last few years, such as JWT and SOLID, among
        others, the code is now more secure against failures, bugs and improper
        access.
      </p>
    </FooterInforsPostweb>
